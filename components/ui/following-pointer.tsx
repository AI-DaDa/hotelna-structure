    ...
    >
      <div className="flex items-center pointer-events-none">
        <svg
          ...
          strokeWidth="1"
          viewBox="0 0 16 16"
          className="h-6 w-6 -rotate-[70deg] transform stroke-yellow-600 text-yellow-500 drop-shadow-lg pointer-events-none"
          height="1em"
          width="1em"
        ...
        <motion.div
          style={{
            backgroundColor: "#d5b15f", // Fixed golden color
          }}
          initial={{
            scale: 0.5,
            opacity: 0,
